...
const DevilContainer = () => {
    ...
    const swapGridCards = (topCard, botCard) => {
        ...
        console.log(copyGridCards)
        // [copyGridCards[topCard], copyGridCards[botCard]] = [copyGridCards[botCard], copyGridCards[topCard]];
    ...
    useEffect(() => {
  	...
  	return (
		<>
			...
			<DevilGrid gridCards={gridCards} setCard={setCard} />
            <StockSection
                talon={talon}
